...
|---|---|---|---|
| W0 | skeleton (`package.json`, `tsconfig`, `bin/`), `types/`, `util/`, this plan | — | skeleton done 2026-09-06; `types/` and `util/` in progress |
| W1 | `loop-file/`, `envelope/`, `usage/`, `store/` — four independent modules | W0 | pending |
| W2 | `engine/` | W0, `types/` from W1 | pending |
| W3 | `backends/` (`fake`, then `local`), `driver/`, `cli/` | W1, W2 | pending |
